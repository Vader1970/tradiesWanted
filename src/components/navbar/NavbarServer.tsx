...
import {
  ...
  middleLineVariants,
  bottomLineVariants,
} from "@/components/navbar/NavAnimations";
            ...
            <div key={index} className="first:pt-4 lg:first:pt-0">
              {navLink.subMenuLinks && navLink.subMenuLinks.length > 0 ? (
                ...
                <Link
                  ...
                  className="block py-3 lg:px-4 lg:py-2 text-primary/80 hover:text-primary text-xl lg:text-sm font-medium transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-primary after:transition-all hover:after:w-full"
                >
                  {navLink.title}
                </Link>
              )}
