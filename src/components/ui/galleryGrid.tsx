      ...
      <div className='grid grid-cols-2 gap-4 lg:gap-6'>
        <div className='space-y-4 lg:space-y-6 pt-8'>
          {[0, 1].map((index) => (
            <div
              key={index}
              className={`image-container ${index === 0 ? "aspect-[3/4]" : "aspect-square"} relative overflow-hidden`}
            >
              <Image
        ...
        <div className='space-y-4 lg:space-y-6'>
          {[2, 3].map((index) => (
            <div
              key={index}
              className={`image-container ${index === 2 ? "aspect-square" : "aspect-[3/4]"} relative overflow-hidden`}
            >
              <Image
                src={images[index].src}
                alt={images[index].alt}
